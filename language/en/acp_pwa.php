...
$lang = array_merge($lang, [
	...
	'ACP_PWA_KIT_APP_ICONS'			=> 'Web application icons (optional)',
	'ACP_PWA_KIT_APP_ICONS_EXPLAIN'	=> 'Used to specify the default icon for your web application. This icon will be used when your web application is added to the home screen. Multiple sizes are preferred for compatibility with various devices. Note that when adding or removing icons, you may need to clear your web browser cache to see them update.',
